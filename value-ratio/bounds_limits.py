...
def get_bound_limits(company_ticker):
    ...
    lower_bound = str(round((mean - 1.96 * standard_error)/1000000000,2))+ ' Bn USD'
    upper_bound = str(round((mean + 1.96 * standard_error)/1000000000,2))+ ' Bn USD'
